...
document.getElementById("newMainContentAreaX1").style.display = "none";
//end new 12/22
...
document.getElementById("newMainContentAreaX1").style.display = "flex";
// end new 12/22
...
var currentCaptureBorderColor;
var oldCaptureBorderColor;

  function newCaptureBorder(color) {

      let vids = document.querySelectorAll('.changeNewBorderColor');

      if (currentCaptureBorderColor == undefined) {
        currentCaptureBorderColor = `newCapture${color}`;
        vids.forEach((vidCapture) => {
          vidCapture.style.backgroundImage = 'none';
          vidCapture.style.backgroundColor = 'none';
          vidCapture.classList.add(currentCaptureBorderColor);
       })  
      }
      else {
        oldCaptureBorderColor = currentCaptureBorderColor;
        currentCaptureBorderColor = `newCapture${color}`;
        vids.forEach((vidCapture) => {
          vidCapture.style.backgroundImage = 'none';
          vidCapture.style.backgroundColor = 'none';
          vidCapture.classList.remove(oldCaptureBorderColor);
          vidCapture.classList.add(currentCaptureBorderColor);
       })  
      }
    }
/*
      vids.forEach((vidCapture) => {
        ...
        if (color == 'green' && currentCaptureBorderColor == undefined) {
          vidCapture.classList.add('newCaptureGreen');
          currentCaptureBorderColor = 'newCaptureGreen';
        }
        else if (color == 'green' && currentCaptureBorderColor != undefined) {
          vidCapture.classList.remove(currentCaptureBorderColor);
          vidCapture.classList.add('newCaptureGreen');
          currentCaptureBorderColor = 'newCaptureGreen';
        }
        else if (color == 'aqua' && currentCaptureBorderColor == undefined) {
        ...
        else if (color == 'red' && currentCaptureBorderColor == undefined) {
        ...
        else if (color == 'orange' && currentCaptureBorderColor == undefined) {
